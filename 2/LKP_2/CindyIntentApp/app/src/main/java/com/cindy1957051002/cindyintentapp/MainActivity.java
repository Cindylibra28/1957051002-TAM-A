package com.cindy1957051002.cindyintentapp;
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Cindy");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 1957051002);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "082363763325";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:"+phoneNumber));
                startActivity(dialPhoneIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Cindy");
                mPerson.setAge(1917051008);
                mPerson.setEmail("cindy@gmail.com");
